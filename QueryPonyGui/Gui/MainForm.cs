#region Fileinfo
// file        : http://downtown.trilo.de/svn/queryponydev/trunk/querypony/QueryPonyGui/Gui/MainForm.cs
// id          : 20130604°0531
// summary     : This file stores class 'MainForm' to constitute the Main Form.
// license     : GNU AGPL v3
...
namespace QueryPonyGui
{
   ...
   public partial class MainForm : Form
   {
      ...
      ///    issue is only partially solved. This property may contain many duplicates.
      /// </remarks>
      ...
      public MainForm(string[] args)
      {
         ...
         // initialisation tasks (sequence 20130707°0904)
         ...
         // (sequence 20130711°0911) output welcome log message number two
         ...
         // (20130812°1402) set e.g. the 'Query Options' menu item availability
         MainForm._mainform.EnableControlsOthers();


         // (sequence 20130814°1012) cosmetic experiment
         // ref : 20130814°1011 'keep split container fixed width'
         this.splitContainer1.FixedPanel = FixedPanel.Panel1;


         // restore connections (sequence 20130828°1524)
      ...
      private void AttachEditManager()
      {
         ...
         _editManager1.MenuItemEdit = editToolStripMenuItem1;                          //// (debug 20130810°1602 'menu items gray')
      ...
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      // (20130725°1412) outsourced her about 600 lines to MainMenu.cs
      ...
      internal IQueryForm GetQueryChild()
      {
         ...
         {
            // fatal?
            // note : E.g. it occurres with the Settings Form on the tab (20130809°1523).
      ...
      /// <remarks>
      /// id : 20130604°0627
      /// note : This is a key location with issue 20130731°0131. Here the 'random named assembly'
      ///    from finding 20130808°1513 is loaded. For details it see debug sequence 20130808°1531
      ///    in Program.cs::AppDomain.CurrentDomain.AssemblyLoad += ()=>{};
      /// note : Here struck issue 20130808°1552 'settings type with library call fails'
      /// note : About issue 20130731°0131 'ServerList settings silently fail'
      ///    see ref 20130808°1541 'Hanselman: Debug into a .NET XmlSerializer'
      ///    see ref 20130808°1542 'Hanselmann: Changing XmlSerializer temporary assemblies'
      ///    see ref 20130808°1543 'Hanselmann: Using XmlSerializer to read/write XML'
      /// </remarks>
      private void LoadServerList()
      {

         // (experiment 20130808°1551)
      ...
      private void MainForm_FormClosed(object sender, FormClosedEventArgs e)
      {
         ...
         // (seqence 20130828°1412) the other end of seqence 20130828°1411
         ...
         // (C) close all open QueryForm Tabs (sequence 20130709°1211)
         ...
         for (int i = 0; i < arQueryforms.Length; i++)
         {
            ...
            {
               // (20130828°1532) try to fight issue 20130828°1531 .. does not help
      ...
      public void ImportServerlist(string filename)
      {
         ...
         //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         // Make new ServerList visible in the Connections Combobox (sequence 20130810°1131)

         // (.1) get handle for the Connect TabPage (sequence 20130810°1133)
      ...
      private void settingsToolStripMenuItem_Click(object sender, EventArgs e)
      {
         ...
         {
            // open Settings Form as form-on-tab (sequence 20130809°1512)
      ...
      private void FurnishFormOnTab(Form fm)
      {
         ...
         */
         ...
         // tag tabpage (compare issue 20130702°1502)
      ...
      public static void furnishNewConnectionDelegateImplementation(DbClient client, ConnSettingsLib connSettingsLib)
      {
         ...
         ////tabpage.Text = client.ConnSettings.Key;
         tabpage.Text = client.ConnSettings.LabelTabpageDatabase;
      ...
      ///    button_Connect_Click(), possibly to be used from there. See todo
      ///    20130828°1522 and todo 20130828°1523.
      /// </remarks>
