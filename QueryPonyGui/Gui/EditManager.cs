#region Fileinfo
// file        : http://downtown.trilo.de/svn/queryponydev/trunk/querypony/QueryPonyGui/Gui/EditManager.cs
// id          : 20130604°0401
...
namespace QueryPonyGui
{
   ...
   public class EditManager //// : Component
   {
      ...
      public ContextMenuStrip GetContextMenuStrip(Control parent)                      //// (debug 20130810°1602 'menu items gray')
      {
      ...
      public void Copy()                                                               //// (debug 20130810°1602 'menu items gray')
      {
      ...
      public void SelectAll()
      {
         ...
         // (sequence 20130810°1624)
         if (ctrl is ComboBox)                                                         //// (debug 20130810°1602 'menu items gray')
         {
            ComboBox cb = (ComboBox) ctrl;
            cb.SelectAll();
         }
      ...
      /// </remarks>
      /// <returns>The wanted control</returns>
      protected Control GetActiveControl()                                             //// (debug 20130810°1602 'menu items gray')
      {
         ...
         //----------------------------------------------------
         // (sequence 20130810°1622 against issue 20130624°1011 'shortcut key fail')
      ...
      /// <param name="containerControl">...</param>
      /// <returns>The wanted control</returns>
      protected Control GetActiveControl(Control containerControl)                     //// (debug 20130810°1602 'menu items gray')
      {
         // (the original lines from the former MDI method)
         ////if (ContainerControl == null || ContainerControl as ContainerControl == null)
         ////{
      ...
      private void EnableSubMenus()
      {
         ...
         ////canUndo = canCopy = canCopyWithHeaders = canCut = canPaste = false;
         ...
         Control ctrl = GetActiveControl();                                            //// (debug 20130810°1602 'menu items gray')
         if (ctrl != null)
         {
            CanEdit ( ctrl
                     , ref canCopy
      ...
      protected void CanEdit ( Control c                                               //// (debug 20130810°1602 'menu items gray')
                              , ref bool canCopy
                                   ...
                                   )
      {
         ...
         // (sequence 20130810°1623) against issue 20130624°1011 'shortcut key fail'
