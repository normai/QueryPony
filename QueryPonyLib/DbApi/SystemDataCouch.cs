#region Fileinfo
// file        : http://downtown.trilo.de/svn/queryponydev/trunk/querypony/QueryPonyLib/DbApi/SystemDataCouch.cs
// id          : 20130719°0901
...
namespace System.Data.CouchDB
{
   ...
   public sealed class CouchDBInfoMessageEventArgs : EventArgs
   {
      ...
      private string _message = ""; // assignment given to avoid compiler warning '.. is never assigned to, ..' (20130719°0903)
   ...
   public sealed class CouchDBConnection : System.Data.Common.DbConnection, ICloneable
   {
      ...
      protected override System.Data.Common.DbCommand CreateDbCommand()
      {
         ...
         ////System.Data.Common.DbCommand dbcommand = new System.Data.Common.DbCommand();
         System.Data.Common.DbCommand dbcommand = null;
      ...
      // (note 20130719°0814) For below properties compiler warns 'is never assigned
      //  to ...'. But they are indeed necessary for the new System.Data.Couch classes.
      // / *
      ...
      /// <remarks>id : 20130716°0913</remarks>
      private string _database = ""; // assignment given to avoid compiler warning '.. is never assigned to, ..' (20130719°090302)

      /// <summary>This field helps implementing the inherited abstract member DataSource.</summary>
      /// <remarks>id : 20130716°0914</remarks>
      private string _dataSource = ""; // assignment given to avoid compiler warning '.. is never assigned to, ..' (20130719°090203)

      /// <summary>This field helps implementing the inherited abstract member ServerVersion.</summary>
      /// <remarks>id : 20130716°0915</remarks>
      private string _serverVersion = ""; // assignment given to avoid compiler warning '.. is never assigned to, ..' (20130719°090304)

      /// <summary>This field helps implementing the inherited abstract member State.</summary>
      /// <remarks>id : 20130716°0916</remarks>
      private ConnectionState _state = ConnectionState.Closed; // assignment given to avoid compiler warning '.. is never assigned to, ..' (20130719°090304)
