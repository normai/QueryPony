#region Fileinfo
// file        : http://downtown.trilo.de/svn/queryponydev/trunk/querypony/QueryPonyLib/Globals.cs
// id          : 20130613°1201
...
namespace QueryPonyLib
{
   ...
   public static class Glb
   {
      ...
      public class Debag
      {
         ...
         /// <summary>This const 'true' tells whether to execute a debug/test sequence or not (toggle this value on demand).</summary>
         /// <remarks>id : 20130608°0123</remarks>
         public static bool ExecuteYes = true;
      ...
      public class SchemaFilter
      {
         ...
         /// <summary>This const "TABLE" tells a schema filter string (not anymore a TreeView Node Item).</summary>
         /// <remarks>id : 20130613°1415</remarks>
         public const string Table = "TABLE";

         /// <summary>This const "VIEW" tells a schema filter string (not anymore a TreeView Node Item).</summary>
...
// (namespace 20130618°0516 experimental)
